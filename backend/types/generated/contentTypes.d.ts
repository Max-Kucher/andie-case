...
export interface ApiCustomSettingCustomSetting extends Schema.CollectionType {
  ...
  info: {
    singularName: 'custom-setting';
    pluralName: 'custom-settings';
    displayName: 'CustomSetting';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    updatedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::custom-setting.custom-setting',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
...
export interface ApiMenuItemMenuItem extends Schema.CollectionType {
  ...
  attributes: {
    ...
    showInHeader: Attribute.Boolean &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
        };
...
export interface ApiOfficerOfficer extends Schema.CollectionType {
